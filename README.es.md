...
# no brew formula yet — build from source              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
# no pacman package yet — build from source            # Arch Linux (Stable)
# no AUR package yet — build from source               # Arch Linux (Latest from AUR)
# build from source: git clone https://github.com/yoyo636/codewright.git               # cualquier sistema
# no nix package yet — build from source           # o github:yoyo636/codewright para la rama dev más reciente
```
...
Codewright también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/yoyo636/codewright/releases) o desde [codewright.dev/download](https://github.com/yoyo636/codewright/download).
...
Más información sobre [agentes](https://github.com/yoyo636/codewright/docs/agents).

### Documentación

Para más información sobre cómo configurar Codewright, [**ve a nuestra documentación**](https://github.com/yoyo636/codewright/docs).
