...
# no brew formula yet — build from source              # macOS ve Linux (resmi brew formülü, daha az güncellenir)
# no pacman package yet — build from source            # Arch Linux (Stable)
# no AUR package yet — build from source               # Arch Linux (Latest from AUR)
# build from source: git clone https://github.com/yoyo636/codewright.git               # Tüm işletim sistemleri
# no nix package yet — build from source           # veya en güncel geliştirme dalı için github:yoyo636/codewright
```
...
[Ajanlar](https://github.com/yoyo636/codewright/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

Codewright'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://github.com/yoyo636/codewright/docs).
