...
# Paket yöneticileri
npm i -g codewright-ai@latest        # veya bun/pnpm/yarn
scoop install codewright             # Windows
choco install codewright             # Windows
brew install anomalyco/tap/codewright # macOS ve Linux (önerilir, her zaman güncel)
...
nix run nixpkgs#codewright           # veya en güncel geliştirme dalı için github:anomalyco/codewright
```
...
Codewright ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/codewright/releases) veya [opencode.ai/download](https://opencode.ai/download) adresinden indirebilirsiniz.
...
Codewright'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://opencode.ai/docs).
...
**Topluluğumuza katılın** [Discord](https://discord.gg/codewright) | [X.com](https://x.com/codewright)
