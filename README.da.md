...
Codewright findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/yoyo636/codewright/releases) eller [opencode.ai/download](https://github.com/yoyo636/codewright/download).
