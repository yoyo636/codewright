...
# no brew formula yet — build from source              # macOS e Linux (fórmula oficial do brew, atualiza menos)
# no pacman package yet — build from source            # Arch Linux (Stable)
# no AUR package yet — build from source               # Arch Linux (Latest from AUR)
# build from source: git clone https://github.com/yoyo636/codewright.git               # qualquer sistema
# no nix package yet — build from source           # ou github:yoyo636/codewright para a branch dev mais recente
```
...
O Codewright também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/yoyo636/codewright/releases) ou em [codewright.dev/download](https://github.com/yoyo636/codewright/download).
...
Saiba mais sobre [agents](https://github.com/yoyo636/codewright/docs/agents).

### Documentação

Para mais informações sobre como configurar o Codewright, [**veja nossa documentação**](https://github.com/yoyo636/codewright/docs).
