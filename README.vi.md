...
npm i -g codewright-ai@latest        # hoặc bun/pnpm/yarn
scoop install codewright             # Windows
choco install codewright             # Windows
brew install anomalyco/tap/codewright # macOS và Linux (khuyên dùng, luôn cập nhật)
...
nix run nixpkgs#codewright           # hoặc github:anomalyco/codewright cho nhánh dev mới nhất
```
...
Codewright cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/codewright/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
...
Để biết thêm thông tin về cách cấu hình Codewright, [**hãy truy cập tài liệu của chúng tôi**](https://opencode.ai/docs).
...
**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/codewright) | [X.com](https://x.com/codewright)
