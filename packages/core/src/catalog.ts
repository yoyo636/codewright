...
import { Catalog } from "@codewright-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/Catalog") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const available = (provider: ProviderV2.Info, integration: Integration.Info | undefined) => {
      ...
      if (provider.integrationID === undefined) return true
      return !integration
    }
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.codewright) {
