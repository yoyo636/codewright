...
import type { Plugin as PluginRuntime } from "@codewright-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/Plugin") {}
