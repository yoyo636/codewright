...
import { ListAnchor } from "@codewright-ai/schema/session"
...
import { SessionDurable } from "@codewright-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/Session") {}
