...
import type { Data, Definition, Payload } from "@codewright-ai/schema/event"
...
import { Durable } from "@codewright-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@codewright-ai/schema/event").ID
export type { Data, Definition, Payload } from "@codewright-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/Event") {}
