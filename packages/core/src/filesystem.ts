...
import { Entry, FileSystem, FindInput, Match } from "@codewright-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@codewright-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/FileSystem") {}
