...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@codewright-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/ToolRegistry") {}
