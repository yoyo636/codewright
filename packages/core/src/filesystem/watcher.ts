...
import { FileSystemWatcher } from "@codewright-ai/schema/filesystem-watcher"
...
declare const CODEWRIGHT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CODEWRIGHT_LIBC === "undefined" ? undefined : CODEWRIGHT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CODEWRIGHT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CODEWRIGHT_EXPERIMENTAL_FILEWATCHER)) {
