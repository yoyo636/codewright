...
export class Service extends Context.Service<Service, Interface>()("@codewright/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CODEWRIGHT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
