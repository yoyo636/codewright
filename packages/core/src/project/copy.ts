...
import { Event } from "@codewright-ai/schema/project-directories"
import { ProjectCopy } from "@codewright-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/ProjectCopy") {}
