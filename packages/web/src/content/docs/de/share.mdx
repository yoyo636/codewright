---
title: Teilen
description: Teile Codewright-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Codewright-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Codewright Folgendes:
...
Codewright hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Codewright den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codewright.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codewright in deiner Organisation einsetzt.
