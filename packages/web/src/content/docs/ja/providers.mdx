...
1. TUI で `/connect` コマンドを実行し、`Codewright Zen` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Codewright Go` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
