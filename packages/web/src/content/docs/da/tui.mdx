---
title: TUI
description: Brug af Codewright-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codewright giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Codewright starter TUI for den nuværende mappe.
...
Når du bruger Codewright TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Codewright. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Codewright. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codewright.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Codewright venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `codewright.default`.
