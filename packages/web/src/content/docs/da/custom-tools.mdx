...
description: Opret værktøjer, som LLM kan kalde codewright ind.
---
...
- Lokalt ved at placere dem i biblioteket `.codewright/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/codewright/tools/`.
