...
1. Kør kommandoen `/connect` i TUI, vælg codewright og gå til [opencode.ai/auth](https://opencode.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Codewright Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
