...
Brug den til at bygge integrasjoner og kontrollere codewright programmatisk.
...
Opret en forekomst av codewright:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codewright.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codewright, kan du oprete en klientforekomst for at koble til den:
