...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite codewright i idite na [opencode.ai/auth](https://opencode.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Codewright Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
