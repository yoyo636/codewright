...
Kreiraj `.codewright/commands/test.md`:
...
Možete dodati prilagođene komande kroz Codewright konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Codewright [config](/docs/config):
...
- Globalno: `~/.config/codewright/commands/`
- Po projektu: `.codewright/commands/`
...
Codewright uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
