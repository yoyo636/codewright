...
Utwórz `.codewright/commands/test.md`:
...
Możesz zdefiniować polecenia w `codewright.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codewright:
...
- Globalnie: `~/.config/codewright/commands/`
- Na projekt: `.codewright/commands/`
...
codewright zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
