...
1. Uruchom polecenie `/connect` w TUI, wybierz `Codewright Zen` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Codewright Go` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
