---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala codewright.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codewright zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie codewright uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI codewright, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do codewright. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij codewright. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `codewright.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Codewright czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `codewright.default`.
