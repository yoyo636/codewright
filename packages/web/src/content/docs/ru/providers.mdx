...
1. Запустите команду `/connect` в TUI, выберите `Codewright Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Codewright Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
