...
Crear `.codewright/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Codewright o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Codewright [config](/docs/config):
...
- Por proyecto: `.codewright/commands/`
...
codewright incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
