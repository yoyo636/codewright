...
1. Ejecute el comando `/connect` en TUI, seleccione codewright y diríjase a [opencode.ai/auth](https://opencode.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Codewright Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
