...
1. Execute o comando `/connect` no TUI, selecione `Codewright Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Codewright Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
