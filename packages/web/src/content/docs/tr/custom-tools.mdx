---
title: Özel Araçlar
description: LLM'un codewright'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. codewright'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.codewright/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/codewright/tools/` içine yerleştirerek.
