---
title: Paylasim
description: codewright konusmalarini genel baglantilarla paylasin.
---

codewright'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda codewright:
...
codewright, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak codewright manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codewright.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codewright kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
