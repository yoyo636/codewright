...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก codewright และไปที่ [opencode.ai/auth](https://opencode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Codewright Go` และไปที่ [opencode.ai/auth](https://opencode.ai/zen)
