...
สร้าง `.codewright/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Codewright:
...
- ระดับผู้ใช้ (Global): `~/.config/codewright/commands/`
- ระดับโปรเจ็กต์: `.codewright/commands/`
...
Codewright มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
