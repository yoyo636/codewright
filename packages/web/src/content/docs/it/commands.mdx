...
Crea `.codewright/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Codewright o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Codewright:
...
- Globale: `~/.config/codewright/commands/`
- Per progetto: `.codewright/commands/`
...
codewright include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
