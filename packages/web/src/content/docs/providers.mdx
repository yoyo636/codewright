...
1. Run the `/connect` command in the TUI, select `Codewright Zen`, and head to [opencode.ai/auth](https://opencode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `Codewright Go`, and head to [opencode.ai/auth](https://opencode.ai/zen).
