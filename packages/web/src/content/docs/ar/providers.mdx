...
1. شغّل الأمر `/connect` في TUI، واختر codewright، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Codewright Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
