...
1. Kjør kommandoen `/connect` i TUI, velg `Codewright Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Codewright Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
