---
title: TUI
description: Bruke codewright-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codewright gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Codewright starter TUI for gjeldende katalog.
...
Når du bruker Codewright TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Codewright. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Codewright. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codewright.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Codewright venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `codewright.default`.
