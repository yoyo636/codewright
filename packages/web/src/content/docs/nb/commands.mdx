...
Opprett `.codewright/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Codewright-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Codewright [config](/docs/config):
...
- Per prosjekt: `.codewright/commands/`
...
Codewright inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
