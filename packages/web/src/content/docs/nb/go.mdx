...
Codewright Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Codewright. Du abonnerer på Codewright Go og
...
Codewright Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Codewright Go fungerer som enhver annen leverandør i Codewright.

1. Du logger inn på **<a href={console}>Codewright Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Codewright Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Codewright Go.
:::
...
Codewright Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Codewright-konfigurasjon
bruker formatet `codewright-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `codewright-go/kimi-k3` i konfigurasjonen din.
...
Vi opprettet Codewright Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Codewright også.
