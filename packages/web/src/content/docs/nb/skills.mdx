...
Agentferdigheter lar Codewright oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går codewright opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
codewright viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `codewright.json`:
