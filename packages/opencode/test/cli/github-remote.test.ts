...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codewright.git")).toEqual({ owner: "sst", repo: "codewright" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codewright")).toEqual({ owner: "sst", repo: "codewright" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codewright.git")).toEqual({ owner: "sst", repo: "codewright" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codewright")).toEqual({ owner: "sst", repo: "codewright" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codewright.git")).toEqual({ owner: "sst", repo: "codewright" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codewright")).toEqual({ owner: "sst", repo: "codewright" })
})
