...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips codewright-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-codewright-directory"]).toBeUndefined()
      expect(forwarded["x-codewright-workspace"]).toBeUndefined()
