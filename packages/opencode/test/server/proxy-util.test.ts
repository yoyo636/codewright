...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips codewright-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-codewright-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-codewright-directory")).toBeNull()
      expect(result.get("x-codewright-workspace")).toBeNull()
