...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODEWRIGHT_CALLER", () => {
    process.env["CODEWRIGHT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODEWRIGHT_CALLER", () => {
    process.env["CODEWRIGHT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODEWRIGHT_CALLER", () => {
    process.env["CODEWRIGHT_CALLER"] = "unknown"
