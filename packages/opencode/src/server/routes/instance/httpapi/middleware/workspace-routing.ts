...
>()("@codewright/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@codewright/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CODEWRIGHT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CODEWRIGHT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-codewright-directory"] || process.cwd()
}
