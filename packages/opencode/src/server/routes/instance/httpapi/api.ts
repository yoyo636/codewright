...
import { makeApi } from "@codewright-ai/protocol/api"
import { LocationMiddleware } from "@codewright-ai/server/location"
import { SessionLocationMiddleware } from "@codewright-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("codewright-root")
...
export const InstanceHttpApi = HttpApi.make("codewright-instance")
...
export const CodewrightHttpApi = HttpApi.make("codewright")
