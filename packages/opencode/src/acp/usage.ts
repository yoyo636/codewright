...
import type { AssistantMessage as CodewrightAssistantMessage, Message } from "@codewright-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@codewright-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<CodewrightAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<CodewrightAssistantMessage, "role"> &
  Partial<Pick<CodewrightAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@codewright/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@codewright/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@codewright/ACPUsage") {}
