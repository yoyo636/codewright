...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@codewright/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@codewright/ACPDirectory") {}
