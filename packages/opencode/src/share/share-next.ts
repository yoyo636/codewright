...
import type * as SDK from "@codewright-ai/sdk/v2"
...
import { SessionShareTable } from "@codewright-ai/core/share/sql"
...
const disabled = process.env["CODEWRIGHT_DISABLE_SHARE"] === "true" || process.env["CODEWRIGHT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/ShareNext") {}
