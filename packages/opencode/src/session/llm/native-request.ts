import type { JsonSchema, LLMRequest, ProviderMetadata } from "@codewright-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@codewright-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @codewright-ai/llm request objects from codewright's session/AI SDK-shaped data.
  return LLM.request({
