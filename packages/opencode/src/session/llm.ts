...
import { llmClient } from "@codewright-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@codewright-ai/llm"
import { LLMClient } from "@codewright-ai/llm/route"
import type { LLMClientService } from "@codewright-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via codewright's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @codewright-ai/llm. It
