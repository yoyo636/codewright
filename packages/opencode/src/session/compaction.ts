...
import { SessionCompactionEvent } from "@codewright-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/SessionCompaction") {}
