...
import { MAX_STEPS_PROMPT } from "@codewright-ai/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/SessionPrompt") {}
