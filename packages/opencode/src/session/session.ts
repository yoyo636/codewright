...
import type { ProviderMetadata, Usage } from "@codewright-ai/llm"
...
import { locationServiceMapLayer } from "@codewright-ai/core/location-services"
...
import { PartTable, SessionTable } from "@codewright-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@codewright-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".codewright", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@codewright/Session") {}
