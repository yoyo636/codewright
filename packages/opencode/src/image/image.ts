...
export class Service extends Context.Service<Service, Interface>()("@codewright/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CODEWRIGHT_PHOTON_WASM_PATH?: string }).__CODEWRIGHT_PHOTON_WASM_PATH =
