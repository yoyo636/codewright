...
import { AbsolutePath, type DeepMutable } from "@codewright-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".codewright", "plans", "*.md")]: "allow",
