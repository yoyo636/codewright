 ...
 *   "@codewright/ServerAuthConfig",
 *   {
 *     password: Config.string("CODEWRIGHT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODEWRIGHT_SERVER_USERNAME").pipe(Config.withDefault("codewright")),
 *   },
 * ) {}
 *
