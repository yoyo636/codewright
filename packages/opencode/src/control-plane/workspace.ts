...
import { EventSequenceTable, EventTable } from "@codewright-ai/core/event/sql"
...
import { WorkspaceEvent } from "@codewright-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CODEWRIGHT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CODEWRIGHT_WORKSPACE_ID: config.id,
        CODEWRIGHT_EXPERIMENTAL_WORKSPACES: "true",
