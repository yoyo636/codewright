...
import { AccountStateTable, AccountTable } from "@codewright-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/AccountRepo") {}
