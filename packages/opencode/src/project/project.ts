...
import { ProjectDirectoryTable, ProjectTable } from "@codewright-ai/core/project/sql"
...
export class Service extends Context.Service<Service, Interface>()("@codewright/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CODEWRIGHT_FAKE_VCS)
