...
//
// The saved variant persists across sessions in ~/.local/state/codewright/model.json
...
class Service extends Context.Service<Service, VariantService>()("@codewright/RunVariant") {}
