...
Practical reference for the current tool-migration state in `packages/codewright`.
...
Tool tests should use the existing Effect helpers in `packages/codewright/test/lib/effect.ts`:
