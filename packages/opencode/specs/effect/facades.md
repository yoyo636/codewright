...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/codewright`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy codewright service removed
