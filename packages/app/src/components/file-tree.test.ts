...
beforeAll(async () => {
  ...
  mock.module("@codewright-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codewright-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codewright-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codewright-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
