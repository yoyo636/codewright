...
beforeAll(async () => {
  ...
  mock.module("@codewright-ai/sdk/v2/client", () => ({
    createCodewrightClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@codewright-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@codewright-ai/core/util/encode", () => ({
