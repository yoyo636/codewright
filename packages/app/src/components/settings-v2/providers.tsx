...
import { Tag } from "@codewright-ai/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "codewright", key: "dialog.provider.codewright.note" },
  { match: (id: string) => id === "codewright-go", key: "dialog.provider.opencodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "codewright" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "codewright" || item.id === "codewright-go"}>
