// @ts-nocheck -- v1/v2 SDK compatibility layer; pending v2 refactor (tracked separately).
import type {
  Config,
  CodewrightClient,
  Path,
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: CodewrightClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => CodewrightClient,
  protocol: Promise<"v1" | "v2">,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, CodewrightClient>()
