import type { OpenCodeEvent as CodewrightEvent, SessionMessageInfo, SessionPendingMessage } from "@codewright-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: CodewrightEvent): V2SessionReduction | undefined => {
