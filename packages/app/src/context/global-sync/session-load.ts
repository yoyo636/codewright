import type { SessionApi } from "@codewright-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { CodewrightClient } from "@codewright-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: CodewrightClient; directory: string; limit: number }) {
  try {
