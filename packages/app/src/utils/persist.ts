...
const GLOBAL_STORAGE = "codewright.global.dat"
const WINDOW_STORAGE = "codewright.window"
const LOCAL_PREFIX = "codewright."
...
function workspaceStorage(dir: string) {
  ...
  return `codewright.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `codewright.draft.${head}.${sum}.dat`
}
