...
import { showToast } from "@codewright-ai/ui/toast"
...
import { LoaderV2 } from "@codewright-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@codewright-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-codewright") {
      await run(() => api.installCodewright(distro))
      return
    }
