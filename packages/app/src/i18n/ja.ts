export const dict = {
  ...
  "dialog.provider.codewright.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.codewright.tagline": "信頼性の高い最適化モデル",
  ...
  "dialog.model.unpaid.freeModels.title": "Codewrightが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Codewrightで{{provider}}モデルを使用します。",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.codewrightZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.codewrightZen.visit.prefix": " ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCodewrightで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Codewrightで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "codewright.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCodewrightサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingCodewright": "Codewrightを確認中...",
  "wsl.onboarding.checkingCodewrightIn": "{{distro}}内のCodewrightを確認中...",
  "wsl.onboarding.updatingCodewright": "Codewrightを更新中...",
  "wsl.onboarding.updatingCodewrightIn": "{{distro}}内のCodewrightを更新中...",
  "wsl.onboarding.updateCodewrightIn": "{{distro}}内のCodewrightを更新してください。",
  "wsl.onboarding.updateCodewright": "Codewrightを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCodewrightの準備ができました。",
  "wsl.onboarding.opencodeReady": "Codewrightの準備ができました。",
  "wsl.onboarding.installCodewrightIn": "{{distro}}にCodewrightをインストールしてください。",
  "wsl.onboarding.installCodewright": "Codewrightをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewrightがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodewrightでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Codewrightをもう一度開いてください。",
  ...
  "toast.update.description": "Codewrightの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.chain.checkConfig": "config (codewright.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CodewrightはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Codewrightには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCodewrightサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Codewrightの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCodewrightの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Codewrightがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Codewrightのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Codewright の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Codewright は最新バージョンです。",
