export const dict = {
  ...
  "dialog.provider.codewright.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Visit ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in codewright.json",
  ...
  "dialog.server.description": "Switch which Codewright server this app connects to.",
  ...
  "wsl.onboarding.checkingCodewright": "Checking Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Checking Codewright in {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Updating Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Updating Codewright in {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Update Codewright in {{distro}}.",
  "wsl.onboarding.updateCodewright": "Update Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright is ready.",
  "wsl.onboarding.installCodewrightIn": "Install Codewright in {{distro}}.",
  "wsl.onboarding.installCodewright": "Install Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Codewright can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Codewright could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Codewright.",
  ...
  "toast.update.description": "A new version of Codewright ({{version}}) is now available to install.",
  ...
  "error.chain.checkConfig": "Check your config (codewright.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Codewright does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Codewright includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Codewright server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Codewright",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Codewright looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Codewright follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Codewright is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Codewright launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Codewright.",
