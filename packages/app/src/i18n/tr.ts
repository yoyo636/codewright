...
export const dict = {
  ...
  "dialog.provider.codewright.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codewright.tagline": "Güvenilir optimize edilmiş modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Codewright tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Codewright'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Codewright'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Codewright'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codewright.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Codewright sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingCodewright": "Codewright kontrol ediliyor...",
  "wsl.onboarding.checkingCodewrightIn": "{{distro}} içinde Codewright kontrol ediliyor...",
  "wsl.onboarding.updatingCodewright": "Codewright güncelleniyor...",
  "wsl.onboarding.updatingCodewrightIn": "{{distro}} içinde Codewright güncelleniyor...",
  "wsl.onboarding.updateCodewrightIn": "{{distro}} içindeki Codewright'u güncelleyin.",
  "wsl.onboarding.updateCodewright": "Codewright'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Codewright hazır.",
  "wsl.onboarding.opencodeReady": "Codewright hazır.",
  "wsl.onboarding.installCodewrightIn": "Codewright'u {{distro}} içine kurun.",
  "wsl.onboarding.installCodewright": "Codewright'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Codewright'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Codewright bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Codewright'u tekrar açın.",
  ...
  "toast.update.description": "Codewright'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Codewright ekibine bildirin",
  "error.page.report.email": "e-posta ile",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codewright.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Codewright henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Codewright ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Codewright Masaüstü",
  ...
  "settings.desktop.wsl.description": "Codewright sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Codewright'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Codewright'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Codewright'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Codewright'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Codewright başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Codewright'un en son sürümünü kullanıyorsunuz.",
