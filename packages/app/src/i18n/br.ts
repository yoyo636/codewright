export const dict = {
  ...
  "dialog.provider.codewright.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codewright.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Codewright",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Visite ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Codewright.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codewright.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Codewright este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingCodewright": "Verificando o Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Verificando o Codewright em {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Atualizando o Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Atualizando o Codewright em {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Atualize o Codewright em {{distro}}.",
  "wsl.onboarding.updateCodewright": "Atualizar o Codewright",
  "wsl.onboarding.opencodeReadyIn": "O Codewright está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Codewright está pronto.",
  "wsl.onboarding.installCodewrightIn": "Instale o Codewright em {{distro}}.",
  "wsl.onboarding.installCodewright": "Instalar o Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Codewright possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Codewright não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Codewright novamente.",
  ...
  "toast.update.description": "Uma nova versão do Codewright ({{version}}) está disponível para instalação.",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codewright.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Codewright ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codewright inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Codewright dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Codewright",
  ...
  "settings.general.row.appearance.description": "Personalize como o Codewright aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Codewright segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Codewright é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Codewright iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Codewright.",
