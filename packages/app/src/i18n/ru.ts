export const dict = {
  ...
  "dialog.provider.codewright.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.codewright.tagline": "Надежные оптимизированные модели",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Codewright",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Посетите ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Codewright.",
  ...
  "dialog.plugins.empty": "Плагины настроены в codewright.json",
  ...
  "dialog.server.description": "Переключите сервер Codewright к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingCodewright": "Проверка Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Проверка Codewright в {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Обновление Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Обновление Codewright в {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Обновите Codewright в {{distro}}.",
  "wsl.onboarding.updateCodewright": "Обновить Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Codewright готов к работе.",
  "wsl.onboarding.installCodewrightIn": "Установите Codewright в {{distro}}.",
  "wsl.onboarding.installCodewright": "Установить Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Codewright требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Codewright не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Codewright.",
  ...
  "toast.update.description": "Новая версия Codewright ({{version}}) доступна для установки.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (codewright.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Codewright пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Codewright включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Codewright внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Codewright",
  ...
  "settings.general.row.appearance.description": "Настройте как Codewright выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Codewright системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Codewright.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Codewright",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Codewright.",
