...
export const dict = {
  ...
  "dialog.provider.codewright.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.codewright.tagline": "Zuverlässige, optimierte Modelle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Codewright",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codewright zu nutzen.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.codewrightZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.codewrightZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Codewright zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codewright zu nutzen.",
  ...
  "dialog.plugins.empty": "In codewright.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Codewright-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.codewright": "Codewright",
  ...
  "wsl.onboarding.checkingCodewright": "Codewright wird geprüft...",
  "wsl.onboarding.checkingCodewrightIn": "Codewright in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingCodewright": "Codewright wird aktualisiert...",
  "wsl.onboarding.updatingCodewrightIn": "Codewright in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateCodewrightIn": "Aktualisieren Sie Codewright in {{distro}}.",
  "wsl.onboarding.updateCodewright": "Codewright aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Codewright ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Codewright ist bereit.",
  "wsl.onboarding.installCodewrightIn": "Installieren Sie Codewright in {{distro}}.",
  "wsl.onboarding.installCodewright": "Codewright installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Codewright einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Codewright konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Codewright erneut.",
  ...
  "toast.update.description": "Eine neue Version von Codewright ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Codewright-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (codewright.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Codewright unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Codewright enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Codewright Desktop",
  ...
  "settings.desktop.wsl.description": "Codewright-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Codewright ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Codewright auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Codewright dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Codewright anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Codewright automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Codewright.",
