export const dict = {
  ...
  "dialog.provider.codewright.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codewright.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Codewright",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Codewright-u.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Posjeti ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Codewright-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Codewright-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codewright.json",
  ...
  "dialog.server.description": "Promijeni na koji se Codewright server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingCodewright": "Provjera Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Provjera Codewright u distribuciji {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Ažuriranje Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Ažuriranje Codewright u distribuciji {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Ažuriraj Codewright u distribuciji {{distro}}.",
  "wsl.onboarding.updateCodewright": "Ažuriraj Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright je spreman.",
  "wsl.onboarding.installCodewrightIn": "Instaliraj Codewright u distribuciji {{distro}}.",
  "wsl.onboarding.installCodewright": "Instaliraj Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Codewright mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Codewright nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Codewright.",
  ...
  "toast.update.description": "Nova verzija Codewright-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (codewright.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Codewright još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Codewright uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Codewright server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Codewright-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Codewright izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Codewright prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Codewright-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Codewright pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Codewright-a.",
