...
export const dict = {
  ...
  "dialog.provider.codewright.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codewright.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Codewright",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Besøk ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Codewright.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codewright.json",
  ...
  "dialog.server.description": "Bytt hvilken Codewright-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Codewright ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codewright.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Codewright ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Codewright inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Codewright-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Codewright",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Codewright ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Codewright skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Codewright er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Codewright starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Codewright.",
  ...
  "wsl.onboarding.checkingCodewright": "Sjekker Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Sjekker Codewright i {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Oppdaterer Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Oppdaterer Codewright i {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Oppdater Codewright i {{distro}}.",
  "wsl.onboarding.updateCodewright": "Oppdater Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright er klar.",
  "wsl.onboarding.installCodewrightIn": "Installer Codewright i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Codewright kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Codewright kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Codewright på nytt.",
