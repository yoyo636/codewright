export const dict = {
  ...
  "dialog.provider.codewright.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.codewright.tagline": "Надійні оптимізовані моделі",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Codewright",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Відвідайте ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Codewright.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в codewright.json",
  ...
  "dialog.server.description": "Перемкніть сервер Codewright, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingCodewright": "Перевірка Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Перевірка Codewright у {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Оновлення Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Оновлення Codewright у {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Оновіть Codewright у {{distro}}.",
  "wsl.onboarding.updateCodewright": "Оновити Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright готовий до роботи.",
  "wsl.onboarding.installCodewrightIn": "Встановіть Codewright у {{distro}}.",
  "wsl.onboarding.installCodewright": "Встановити Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Codewright потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Codewright не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Codewright.",
  ...
  "toast.update.description": "Нова версія Codewright ({{version}}) тепер доступна для встановлення.",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (codewright.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Codewright ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codewright містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Codewright всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Codewright",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Codewright на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Codewright використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Codewright.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Codewright",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Codewright.",
