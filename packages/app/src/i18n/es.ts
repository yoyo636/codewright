export const dict = {
  ...
  "dialog.provider.codewright.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codewright.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Codewright",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.codewrightZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.codewrightZen.visit.prefix": "Visita ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Codewright.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codewright.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Codewright se conecta esta app.",
  ...
  "wsl.onboarding.checkingCodewright": "Comprobando Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Comprobando Codewright en {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Actualizando Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Actualizando Codewright en {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Actualiza Codewright en {{distro}}.",
  "wsl.onboarding.updateCodewright": "Actualizar Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright está listo.",
  "wsl.onboarding.installCodewrightIn": "Instala Codewright en {{distro}}.",
  "wsl.onboarding.installCodewright": "Instalar Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Codewright pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Codewright no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Codewright.",
  ...
  "toast.update.description": "Una nueva versión de Codewright ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Codewright",
  "error.page.report.email": "por correo",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codewright.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Codewright no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Codewright incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Codewright dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Codewright",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Codewright en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Codewright sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Codewright.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Codewright",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Codewright.",
