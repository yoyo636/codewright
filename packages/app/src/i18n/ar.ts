export const dict = {
  ...
  "dialog.provider.codewright.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.codewright.tagline": "نماذج موثوقة ومحسنة",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Codewright",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "يمنحك Codewright Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "قم بزيارة ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Codewright.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في codewright.json",
  ...
  "dialog.server.description": "تبديل خادم Codewright الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingCodewright": "جارٍ التحقق من Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "جارٍ التحقق من Codewright في {{distro}}...",
  "wsl.onboarding.updatingCodewright": "جارٍ تحديث Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "جارٍ تحديث Codewright في {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "حدّث Codewright في {{distro}}.",
  "wsl.onboarding.updateCodewright": "تحديث Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright جاهز.",
  "wsl.onboarding.installCodewrightIn": "ثبّت Codewright في {{distro}}.",
  "wsl.onboarding.installCodewright": "تثبيت Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Codewright من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Codewright التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Codewright.",
  ...
  "toast.update.description": "نسخة جديدة من Codewright ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (codewright.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Codewright لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Codewright نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Codewright داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Codewright",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Codewright على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Codewright يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Codewright.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Codewright",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Codewright.",
