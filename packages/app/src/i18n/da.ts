export const dict = {
  ...
  "dialog.provider.codewright.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codewright.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Codewright",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Besøg ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Codewright.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codewright.json",
  ...
  "dialog.server.description": "Skift hvilken Codewright-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingCodewright": "Tjekker Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Tjekker Codewright i {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Opdaterer Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Opdaterer Codewright i {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Opdater Codewright i {{distro}}.",
  "wsl.onboarding.updateCodewright": "Opdater Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Codewright kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Codewright kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Codewright igen.",
  ...
  "toast.update.description": "En ny version af Codewright ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (codewright.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Codewright understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Codewright inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Codewright-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Codewright",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Codewright ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Codewright følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Codewright er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Codewright starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Codewright.",
