export const dict = {
  ...
  "dialog.provider.codewright.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codewright.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Codewright",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Visitez ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Codewright.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans codewright.json",
  ...
  "dialog.server.description": "Changez le serveur Codewright auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingCodewright": "Vérification d'Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Vérification d'Codewright dans {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Mise à jour d'Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Mise à jour d'Codewright dans {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Mettez à jour Codewright dans {{distro}}.",
  "wsl.onboarding.updateCodewright": "Mettre à jour Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright est prêt.",
  "wsl.onboarding.installCodewrightIn": "Installez Codewright dans {{distro}}.",
  "wsl.onboarding.installCodewright": "Installer Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Codewright puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Codewright n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Codewright.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Codewright ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codewright.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Codewright ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Codewright inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Codewright dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Codewright",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Codewright sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Codewright suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Codewright.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Codewright",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Codewright.",
