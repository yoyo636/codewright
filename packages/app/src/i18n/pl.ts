export const dict = {
  ...
  "dialog.provider.codewright.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codewright.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Codewright",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Codewright.",
  ...
  "provider.connect.codewrightZen.line1":
    "Codewright Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.codewrightZen.visit.prefix": "Odwiedź ",
  "provider.connect.codewrightZen.visit.link": "codewright.dev/zen",
  "provider.connect.codewrightZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Codewright.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Codewright.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codewright.json",
  ...
  "dialog.server.description": "Przełącz serwer Codewright, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingCodewright": "Sprawdzanie Codewright...",
  "wsl.onboarding.checkingCodewrightIn": "Sprawdzanie Codewright w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingCodewright": "Aktualizowanie Codewright...",
  "wsl.onboarding.updatingCodewrightIn": "Aktualizowanie Codewright w dystrybucji {{distro}}...",
  "wsl.onboarding.updateCodewrightIn": "Zaktualizuj Codewright w dystrybucji {{distro}}.",
  "wsl.onboarding.updateCodewright": "Zaktualizuj Codewright",
  "wsl.onboarding.opencodeReadyIn": "Codewright jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codewright jest gotowy.",
  "wsl.onboarding.installCodewrightIn": "Zainstaluj Codewright w dystrybucji {{distro}}.",
  "wsl.onboarding.installCodewright": "Zainstaluj Codewright",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codewright nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Codewright będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Codewright nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Codewright.",
  ...
  "toast.update.description": "Nowa wersja Codewright ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Codewright",
  "error.page.report.email": "przez e-mail",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codewright.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Codewright nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Codewright zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Codewright wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Codewright",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Codewright na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Codewright ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Codewright.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Codewright",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Codewright.",
