...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "CODEWRIGHT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/codewright/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/codewright (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/codewright/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/codewright/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CODEWRIGHT_DB|CODEWRIGHT_DB|CODEWRIGHT_DEV|Global\\.Path\\.data|data =" in packages/codewright/src (115 matches)',
  },
] as const
