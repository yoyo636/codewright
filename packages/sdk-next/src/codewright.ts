import { Codewright } from "@codewright-ai/client/effect"
...
export const create = Effect.fn("Codewright.create")(function* () {
  ...
  const client = yield* Codewright.make({ baseUrl: "http://codewright.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@codewright-ai/sdk-next/Codewright") {}
