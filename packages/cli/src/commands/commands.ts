...
declare const CODEWRIGHT_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CODEWRIGHT_CLI_NAME === "string" ? CODEWRIGHT_CLI_NAME : "codewright", {
  description: "Codewright 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
