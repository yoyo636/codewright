export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Codewright を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Codewright のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'codewright' コマンドを使用してください。",
