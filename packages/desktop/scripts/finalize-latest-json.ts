...
const releaseId = process.env.CODEWRIGHT_RELEASE
if (!releaseId) throw new Error("CODEWRIGHT_RELEASE is required")

const version = process.env.CODEWRIGHT_VERSION
if (!version) throw new Error("CODEWRIGHT_VERSION is required")
...
const macxTarGz = "codewright-desktop-mac-x64.app.tar.gz"
const macaTarGz = "codewright-desktop-mac-arm64.app.tar.gz"
