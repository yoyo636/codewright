...
export const TypeId: TypeId = "~@codewright-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@codewright-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@codewright-ai/effect-sqlite-node/NodeSqliteClient")
