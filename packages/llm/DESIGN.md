...
> current private `@codewright-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@codewright-ai/ai`
...
- Secondary audience: Codewright and other durable agent runtimes
...
import { LLM } from "@codewright-ai/ai"
import { OpenAI } from "@codewright-ai/ai/providers/openai"
...
```ts
import { Message } from "@codewright-ai/ai"
...
import { LLM, Tool } from "@codewright-ai/ai"
...
Codewright and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@codewright-ai/ai/promise"
import { OpenAI } from "@codewright-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@codewright-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@codewright-ai/ai/provider"
...
@codewright-ai/ai/promise
  Promise/AsyncIterable LLM facade

@codewright-ai/ai/schema
  serializable domain schemas

@codewright-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@codewright-ai/ai/providers/openai
@codewright-ai/ai/providers/anthropic
@codewright-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@codewright-ai/llm`                      | `@codewright-ai/ai`                                           |
...
Codewright should migrate to `generateTurn` / `streamTurn`, preserving its durable
