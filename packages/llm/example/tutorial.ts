...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@codewright-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@codewright-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-codewright-tutorial": "1" },
    query: { debug: "1" },
  },
})
