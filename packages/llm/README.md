...
Schema-first LLM core for codewright. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@codewright-ai/llm"
import { OpenAI } from "@codewright-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@codewright-ai/llm/providers"
