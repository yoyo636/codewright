...
import { isSessionNotFoundError, isUnauthorizedError, Codewright } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = Codewright.make({ baseUrl: "http://localhost:3000" })
