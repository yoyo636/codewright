...
import { compile, emitEffectImported, emitPromise, write } from "@codewright-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "CodewrightEventEncoded",
              import: 'import type { CodewrightEventEncoded } from "@codewright-ai/protocol/groups/event"',
            },
          },
        }),
