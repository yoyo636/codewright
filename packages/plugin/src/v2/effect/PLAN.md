...
- Effect plugins import `@codewright-ai/plugin/v2/effect`, not `@codewright-ai/core`.
- Public domain values use generated `@codewright-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@codewright-ai/plugin/v2/effect`.
