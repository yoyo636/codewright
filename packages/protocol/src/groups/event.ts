...
import type { Definition } from "@codewright-ai/schema/event"
...
export const CodewrightEvent = event.schema
export type CodewrightEvent = typeof CodewrightEvent.Type
export type CodewrightEventEncoded = typeof CodewrightEvent.Encoded
