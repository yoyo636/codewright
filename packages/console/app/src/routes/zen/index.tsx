...
import compareVideo from "../../asset/lander/codewright-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codewright-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codewright:auth" content={loggedin() ? "true" : "false"} />
