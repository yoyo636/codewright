...
class Database extends Context.Service<Database, DatabaseShape>()("@codewright/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@codewright/example/UserStore") {
