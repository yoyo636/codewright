...
import {
  ...
  type StatsHomeData,
  type StatsLabData,
} from "@codewright-ai/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Codewright" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent Codewright Go usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
