export const dict = {
  "app.title": "Rankingi użycia modeli AI | Codewright Data",
  "app.description":
    "Przeglądaj użycie Codewright Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Codewright Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Codewright na GitHub",
  "header.github": "GitHub",
  "header.tryCodewright": "Wypróbuj Codewright",
  ...
  "footer.homeAria": "Strona główna Codewright",
  ...
  "home.topModelsDescription": "Użycie modeli w Codewright Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Codewright Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Codewright Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Codewright Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Codewright.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Codewright",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Codewright",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Codewright z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Codewright Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Codewright Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Codewright Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Codewright Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Codewright Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Codewright Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Codewright Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Codewright Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Codewright Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Codewright Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Codewright Go.",
  ...
  "model.geoDescription": "Tokeny modelu Codewright Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Codewright Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Codewright Go.",
