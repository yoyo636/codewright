export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Codewright Data",
  "app.description":
    "Codewright Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Codewright Data logosu",
  ...
  "header.githubAria": "GitHub'da Codewright'a yıldız ver",
  "header.github": "GitHub",
  "header.tryCodewright": "Codewright'u dene",
  ...
  "footer.homeAria": "Codewright ana sayfası",
  ...
  "modal.title": "Codewright Bülteni",
  ...
  "home.topModelsDescription": "Codewright Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Codewright Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Codewright Data",
  "lab.description":
    "Codewright Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Codewright kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Codewright'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Codewright kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Codewright token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Codewright Data",
  "model.description":
    "{{model}} için Codewright Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Codewright Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Codewright Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Codewright Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Codewright Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Codewright Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Codewright Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Codewright Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Codewright Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Codewright Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Codewright Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Codewright Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Codewright Go token hacmine göre yakındaki modeller.",
