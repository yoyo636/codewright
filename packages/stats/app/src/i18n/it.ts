export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Codewright Data",
  "app.description":
    "Esplora l'utilizzo di Codewright Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Codewright Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Codewright su GitHub",
  "header.github": "GitHub",
  "header.tryCodewright": "Prova Codewright",
  ...
  "footer.homeAria": "Home Codewright",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Codewright Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Codewright Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Codewright Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Codewright Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Codewright.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Codewright",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Codewright",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Codewright negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Codewright Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Codewright Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Codewright Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Codewright Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Codewright Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Codewright Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Codewright Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Codewright Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Codewright Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Codewright Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Codewright Go.",
  ...
  "model.geoDescription": "Token del modello Codewright Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Codewright Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Codewright Go.",
