...
const en = {
  "app.title": "AI Model Usage Rankings | Codewright Data",
  "app.description":
    "Explore Codewright Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Codewright Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Codewright on GitHub",
  "header.github": "GitHub",
  "header.tryCodewright": "Try Codewright",
  ...
  "footer.homeAria": "Codewright home",
  ...
  "home.topModelsDescription": "Usage of models across Codewright Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Codewright Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Codewright Data",
  "lab.description":
    "Compare {{lab}} models used in Codewright Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Codewright usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Codewright",
  ...
  "lab.shareOfUsage": "{{share}} of recent Codewright usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Codewright Data",
  "model.description":
    "View {{model}} Codewright Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Codewright Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Codewright Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Codewright Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Codewright Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Codewright Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Codewright Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Codewright Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Codewright Go token volume.",
