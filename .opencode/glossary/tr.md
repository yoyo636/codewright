...
- PR #15835: https://github.com/anomalyco/codewright/pull/15835

## Do Not Translate (Locale Additions)

- `Codewright` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `codewright` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Codewright` in prose, `codewright` only for exact technical identifiers
...
- Avoid changing `codewright` to `Codewright` inside commands, URLs, package names, or code literals
