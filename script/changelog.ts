...
Generates UPCOMING_CHANGELOG.md by running the codewright changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for codewright run (default: low)
      --quiet            Suppress codewright command output unless it fails
