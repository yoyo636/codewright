...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/codewright/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/codewright...\n")
...
console.log("Fetching npm all-time downloads for codewright-ai...\n")
const npmDownloads = await fetchNpmDownloads("codewright-ai")
