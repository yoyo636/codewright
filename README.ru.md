...
# no brew formula yet — build from source              # macOS и Linux (официальная формула brew, обновляется реже)
# no pacman package yet — build from source            # Arch Linux (Stable)
# no AUR package yet — build from source               # Arch Linux (Latest from AUR)
# build from source: git clone https://github.com/yoyo636/codewright.git               # любая ОС
# no nix package yet — build from source           # или github:yoyo636/codewright для самой свежей ветки dev
```
...
Codewright также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/yoyo636/codewright/releases) или с [codewright.dev/download](https://github.com/yoyo636/codewright/download).
