...
# Менеджеры пакетов
npm i -g codewright-ai@latest        # или bun/pnpm/yarn
scoop install codewright             # Windows
choco install codewright             # Windows
brew install anomalyco/tap/codewright # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#codewright           # или github:anomalyco/codewright для самой свежей ветки dev
```
...
Codewright также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/anomalyco/codewright/releases) или с [opencode.ai/download](https://opencode.ai/download).
...
Больше информации о том, как настроить Codewright: [**наши docs**](https://opencode.ai/docs).
...
**Присоединяйтесь к нашему сообществу** [Discord](https://discord.gg/codewright) | [X.com](https://x.com/codewright)
