...
nix run nixpkgs#codewright           # or github:yoyo636/opencode for latest dev branch
```
...
Codewright ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/yoyo636/opencode/releases) অথবা [opencode.ai/download](https://github.com/yoyo636/opencode/download) থেকে ডাউনলোড করুন।
...
1. `$CODEWRIGHT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.codewright/bin` - ডিফল্ট ফলব্যাক
...
Codewright এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://github.com/yoyo636/opencode/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Codewright কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://github.com/yoyo636/opencode/docs)।

### অবদান (Contributing)

আপনি যদি Codewright এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Codewright এর উপর বিল্ডিং (Building on Codewright)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Codewright এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "codewright" ব্যবহার করেন, উদাহরণস্বরূপ "codewright-dashboard" বা "codewright-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Codewright দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।
